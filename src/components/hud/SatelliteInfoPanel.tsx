...
export function SatelliteInfoPanel() {
  ...
  return (
    <div className="absolute top-1/2 left-5 -translate-y-1/2 w-52 animate-slide-up pointer-events-auto hidden lg:flex flex-col gap-2.5">
      {/* Header */}
      <div
        className="bg-space-900/85 backdrop-blur-sm border border-white/10 px-4 py-3 flex items-center justify-between"
        style={{
      ...
      {/* Data rows */}
      <div
        className="bg-space-900/90 backdrop-blur-sm border border-white/5 border-t-0"
        style={{
          borderLeft: `2px solid ${catMeta.color}`,
        }}
      >
      ...
      {/* TLE snippet */}
      <div
        className="bg-space-900/90 backdrop-blur-sm border border-white/5 border-t-0 px-3 py-2"
        style={{
          borderLeft: `2px solid ${catMeta.color}`,
        }}
      >
